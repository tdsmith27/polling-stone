  ...
  render(){
    return (
      ...
      {this.state.candidates.map((candidate) => {
        ...
        <img alt={'test'} style={{margin:'10px auto 10px', maxHeight:'200px', maxWidth:'100%'}} src={candidate['photo-url']} />
        </div>
        <div className="candidate-card-name" style={{color:'black', fontSize:'22px', marginBottom: '10px', marginTop:'20px'}}>{candidate['first-name']}<br/>{candidate['last-name']} </div>
