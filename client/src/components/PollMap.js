...
class PollMap extends React.Component {
    ...
    handleMouseEnter(e, i) {
      $(e.target.parentNode).append(
        `<div class="removeme" style=${removeMeStyle}>
    ...
    render(){ 
        ...
        <input onChange={this.handleInput} type="text" placeholder="Search Polls by Zipcode" style={mapInputStyle}></input>
        </form>
        {this.state.markers.map((pin, i) => {
            return (
                    ...
                    <div style={markerDivStyle}><img src="http://ichef.bbci.co.uk/news/976/cpsprodpb/12787/production/_95455657_3312a880-230e-474c-b1d9-bb7c94f8b00e.jpg" height="15" width="15" style={markerImageStyle}></img></div>
                    </Marker>
            )
        })}
        </Map>
...
const removeMeStyle = "padding:5px;text-align:left;margin-left:150px;background-color:white;width:150px;grid-column:1;grid-row:1";
